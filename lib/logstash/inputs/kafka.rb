...
class LogStash::Inputs::Kafka < LogStash::Inputs::Base
  ...
  # The fully qualified name of a Sasl client callback handler class that implements the org.apache.kafka.common.security.auth.AuthenticateCallbackHandler interface.
  config :sasl_client_callback_handler_class, :validate => :string
